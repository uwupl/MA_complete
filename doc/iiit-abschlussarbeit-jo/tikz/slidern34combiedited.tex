...
\draw[draw=none,fill=crimson] (axis cs:0.6,0) rectangle (axis cs:1,17.9468727111816);
...
\draw[draw=none,fill=purple] (axis cs:0.6,17.9468727111816) rectangle (axis cs:1,21.6246275901794);
...
\draw[draw=none,fill=slateblue] (axis cs:0.6,21.6246275901794) rectangle (axis cs:1,28.7721772193909);
...
\draw[draw=none,fill=darkgoldenrod] (axis cs:0.6,28.7721772193909) rectangle (axis cs:1,28.8058715350926);
...
%   rotate=0.0
% ]{10,37};
% \draw (axis cs:0.8,17.9468727111816) ++(0pt,-2pt) node[
%   scale=1.0,
%   anchor=south,
%   text=black,
%   rotate=0.0
...
\draw (axis cs:0.8,28.8058715350926) ++(0pt,-2pt) node[
  scale=1.0,
  anchor=south,
  text=black,
  rotate=0.0
...
\draw[draw=none,fill=black] (axis cs:1.04,0) rectangle (axis cs:1.16,95.8180069923401);
...
\draw[draw=none,fill=gray] (axis cs:1.24,0) rectangle (axis cs:1.36,96.8387305736542);
...
\draw (axis cs:1.1,95.8180069923401) ++(0pt,-2pt) node[
  scale=1.0,
  anchor=south,
  text=black,
  rotate=0.0
...
\draw (axis cs:1.3,96.8387305736542) ++(0pt,-2pt) node[
  scale=1.0,
  anchor=south,
  text=black,
  rotate=0.0
